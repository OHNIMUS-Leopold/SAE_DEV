<template>
 <div class="bg-gradient-to-r from-d1 via-d2 to-d3 rounded-[20px] my-[136px] mx-[348px]">
    ...
    <form class="flex flex-col font-Poppins text-black">
      ...
      <input type="submit" value="SE CONNECTER" style="filter:drop-shadow(0px 10px 10px gray)" class="text-white uppercase rounded-[10px] mb-[22px] font-Poppins font-bold text-[15px] leading-[26px] mx-[270px] py-3 tracking-normal bg-ocean-blue hover:text-black">
    </form>
